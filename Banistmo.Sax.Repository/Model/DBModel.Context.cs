...
namespace Banistmo.Sax.Repository.Model
{
    ...
    public partial class DBModelEntities : DbContext
    {
        ...
        public virtual ObjectResult<SAX_REPORTE_USUARIOS_Result> SAX_REPORTE_USUARIO()
        {
            return ((IObjectContextAdapter)this).ObjectContext.ExecuteFunction<SAX_REPORTE_USUARIOS_Result>("SAX_REPORTE_USUARIO");
        }
