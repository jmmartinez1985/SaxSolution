...
namespace Banistmo.Sax.Repository.Model
{
    ...
    public partial class DBModelEntities : DbContext
    {
        ...
        public virtual int usp_consulta_comprobante_por_Anular()
        {
            return ((IObjectContextAdapter)this).ObjectContext.ExecuteFunction("usp_consulta_comprobante_por_Anular");
        }
    }
}
