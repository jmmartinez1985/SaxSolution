...
namespace Banistmo.Sax.Repository.Model
{
    ...
    public partial class DBModelEntities : DbContext
    {
        ...
        public virtual ObjectResult<SAX_REPORTE_USUARIO1_Result> SAX_REPORTE_USUARIO1()
        {
            return ((IObjectContextAdapter)this).ObjectContext.ExecuteFunction<SAX_REPORTE_USUARIO1_Result>("SAX_REPORTE_USUARIO1");
        }
    
        public virtual ObjectResult<SAX_REPORTE_ROLES_MENU1_Result> SAX_REPORTE_ROLES_MENU1()
        {
            return ((IObjectContextAdapter)this).ObjectContext.ExecuteFunction<SAX_REPORTE_ROLES_MENU1_Result>("SAX_REPORTE_ROLES_MENU1");
        }
    }
}
