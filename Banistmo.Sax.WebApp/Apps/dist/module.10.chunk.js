webpackJsonp(["module.10"],{

/***/ "./src/app/pages/params/approve/component.html":
...
/***/ "./src/app/pages/params/approve/component.ts":
...
var ApproveComponent = /** @class */ (function () {
    function ApproveComponent(http) {
        this.http = http;
    ...
    ApproveComponent.prototype.changePage = function (page, data) {
        if (data === void 0) { data = this.data; }
        var start = (page.page - 1) * page.itemsPerPage;
        var end = page.itemsPerPage > -1 ? (start + page.itemsPerPage) : data.length;
        return data.slice(start, end);
    };
    ApproveComponent.prototype.changeSort = function (data, config) {
        if (!config.sorting) {
            return data;
        }
    ...
    ApproveComponent.prototype.changeFilter = function (data, config) {
        var _this = this;
    ...
    ApproveComponent.prototype.onChangeTable = function (config, page) {
    ...
    ApproveComponent = __decorate([
        Object(__WEBPACK_IMPORTED_MODULE_0__angular_core__["Component"])({
            selector: 'app-table',
            template: __webpack_require__("./src/app/pages/params/approve/component.html")
        }),
...
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_3__component__ = __webpack_require__("./src/app/pages/params/approve/component.ts");
...
var TABLE_ROUTES = [
    { path: '', component: __WEBPACK_IMPORTED_MODULE_3__component__["a" /* ApproveComponent */] }
];
var ApproveModule = /** @class */ (function () {
    ...
    ApproveModule = __decorate([
        Object(__WEBPACK_IMPORTED_MODULE_1__angular_core__["NgModule"])({
            declarations: [
                __WEBPACK_IMPORTED_MODULE_3__component__["a" /* ApproveComponent */]
            ],
            imports: [
...
//# sourceMappingURL=module.10.chunk.js.map