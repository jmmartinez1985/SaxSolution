webpackJsonp(["module.13"],{

/***/ "./src/app/pages/daily/manual-loading/component.html":
/***/ (function(module, exports) {

module.exports = "<section class=\"content\">\r\n  <header class=\"content__title\">\r\n    <h1>Data Table</h1>\r\n\r\n    <div class=\"actions\">\r\n      <a class=\"actions__item zmdi zmdi-trending-up\" [routerLink]=\"['/table/data-table']\"></a>\r\n      <a class=\"actions__item zmdi zmdi-check-all\" [routerLink]=\"['/table/data-table']\"></a>\r\n      <div dropdown>\r\n        <i dropdownToggle class=\"actions__item zmdi zmdi-more-vert\"></i>\r\n        <div *dropdownMenu class=\"dropdown-menu dropdown-menu-right\">\r\n          <a [routerLink]=\"['/table/data-table']\" class=\"dropdown-item\">Refresh</a>\r\n          <a [routerLink]=\"['/table/data-table']\" class=\"dropdown-item\">Manage Widgets</a>\r\n          <a [routerLink]=\"['/table/data-table']\" class=\"dropdown-item\">Settings</a>\r\n        </div>\r\n      </div>\r\n    </div>\r\n  </header>\r\n\r\n\r\n  <div class=\"card\">\r\n    <div class=\"card-body\">\r\n      <h4 class=\"card-title\">ng2-Table</h4>\r\n      <h6 class=\"card-subtitle\">Native Angular2 directives for Tables with sorting, filtering, paging...</h6>\r\n\r\n      <div class=\"data-table\">\r\n        <div class=\"data-table__header\">\r\n          <div class=\"form-group data-table__filter\">\r\n            <input *ngIf=\"config.filtering\"\r\n                   placeholder=\"Filter all columns\"\r\n                   [ngTableFiltering]=\"config.filtering\"\r\n                   class=\"form-control\"\r\n                   (tableChanged)=\"onChangeTable(config)\"/>\r\n            <i class=\"form-group__bar\"></i>\r\n          </div>\r\n        </div>\r\n\r\n        <ng-table [config]=\"config\"\r\n                  (tableChanged)=\"onChangeTable(config)\"\r\n                  [rows]=\"rows\" [columns]=\"columns\">\r\n        </ng-table>\r\n\r\n        <div class=\"data-table__footer\">\r\n          <pagination *ngIf=\"config.paging\"\r\n                      [(ngModel)]=\"page\"\r\n                      [totalItems]=\"length\"\r\n                      [itemsPerPage]=\"itemsPerPage\"\r\n                      [maxSize]=\"maxSize\"\r\n                      [boundaryLinks]=\"true\"\r\n                      [rotate]=\"false\"\r\n                      (pageChanged)=\"onChangeTable(config, $event)\"\r\n                      (numPages)=\"numPages = $event\">\r\n          </pagination>\r\n        </div>\r\n      </div>\r\n    </div>\r\n  </div>\r\n</section>\r\n"

/***/ }),

/***/ "./src/app/pages/daily/manual-loading/component.ts":
/***/ (function(module, __webpack_exports__, __webpack_require__) {

"use strict";
/* harmony export (binding) */ __webpack_require__.d(__webpack_exports__, "a", function() { return ManualLoadingComponent; });
...
var ManualLoadingComponent = /** @class */ (function () {
    function ManualLoadingComponent(http) {
        this.http = http;
        this.rows = [{ "id": 1, "first_name": "Wanda", "last_name": "Morales", "email": "wmorales0@e-recht24.de", "gender": "Female", "ip_address": "168.21.40.204" },
    ...
    ManualLoadingComponent.prototype.changePage = function (page, data) {
        if (data === void 0) { data = this.data; }
        var start = (page.page - 1) * page.itemsPerPage;
        var end = page.itemsPerPage > -1 ? (start + page.itemsPerPage) : data.length;
        return data.slice(start, end);
    };
    ManualLoadingComponent.prototype.changeSort = function (data, config) {
        if (!config.sorting) {
            return data;
        }
    ...
    ManualLoadingComponent.prototype.changeFilter = function (data, config) {
        var _this = this;
    ...
    ManualLoadingComponent.prototype.onChangeTable = function (config, page) {
    ...
    ManualLoadingComponent.prototype.ngOnInit = function () {
        this.onChangeTable(this.config);
    };
    ManualLoadingComponent = __decorate([
        Object(__WEBPACK_IMPORTED_MODULE_0__angular_core__["Component"])({
            selector: 'app-table',
            template: __webpack_require__("./src/app/pages/daily/manual-loading/component.html")
        }),
        __metadata("design:paramtypes", [__WEBPACK_IMPORTED_MODULE_1__angular_http__["a" /* Http */]])
    ], ManualLoadingComponent);
    return ManualLoadingComponent;
}());
...
/* harmony export (binding) */ __webpack_require__.d(__webpack_exports__, "ManualLoadingModule", function() { return ManualLoadingModule; });
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_0__angular_common__ = __webpack_require__("./node_modules/@angular/common/esm5/common.js");
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_1__angular_core__ = __webpack_require__("./node_modules/@angular/core/esm5/core.js");
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_2__angular_router__ = __webpack_require__("./node_modules/@angular/router/esm5/router.js");
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_3__component__ = __webpack_require__("./src/app/pages/daily/manual-loading/component.ts");
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_4_ng2_table__ = __webpack_require__("./node_modules/ng2-table/ng2-table.js");
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_4_ng2_table___default = __webpack_require__.n(__WEBPACK_IMPORTED_MODULE_4_ng2_table__);
...
var TABLE_ROUTES = [
    { path: '', component: __WEBPACK_IMPORTED_MODULE_3__component__["a" /* ManualLoadingComponent */] }
];
var ManualLoadingModule = /** @class */ (function () {
    function ManualLoadingModule() {
    }
    ManualLoadingModule = __decorate([
        Object(__WEBPACK_IMPORTED_MODULE_1__angular_core__["NgModule"])({
            declarations: [
                __WEBPACK_IMPORTED_MODULE_3__component__["a" /* ManualLoadingComponent */]
            ],
            imports: [
                __WEBPACK_IMPORTED_MODULE_0__angular_common__["CommonModule"],
                __WEBPACK_IMPORTED_MODULE_5__angular_forms__["b" /* FormsModule */],
                __WEBPACK_IMPORTED_MODULE_6_ngx_bootstrap_pagination__["a" /* PaginationModule */].forRoot(),
                __WEBPACK_IMPORTED_MODULE_4_ng2_table__["Ng2TableModule"],
                __WEBPACK_IMPORTED_MODULE_2__angular_router__["c" /* RouterModule */].forChild(TABLE_ROUTES)
            ]
        })
    ], ManualLoadingModule);
    return ManualLoadingModule;
}());
...
//# sourceMappingURL=module.13.chunk.js.map