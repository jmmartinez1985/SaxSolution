webpackJsonp(["module.4"],{

/***/ "./src/app/pages/reports/balances/component.html":
...
/***/ "./src/app/pages/reports/balances/component.ts":
...
var BalancesComponent = /** @class */ (function () {
    function BalancesComponent(http) {
        this.http = http;
    ...
    BalancesComponent.prototype.changePage = function (page, data) {
        if (data === void 0) { data = this.data; }
        var start = (page.page - 1) * page.itemsPerPage;
        var end = page.itemsPerPage > -1 ? (start + page.itemsPerPage) : data.length;
        return data.slice(start, end);
    };
    BalancesComponent.prototype.changeSort = function (data, config) {
        if (!config.sorting) {
            return data;
        }
    ...
    BalancesComponent.prototype.changeFilter = function (data, config) {
        var _this = this;
    ...
    BalancesComponent.prototype.onChangeTable = function (config, page) {
    ...
    BalancesComponent = __decorate([
        Object(__WEBPACK_IMPORTED_MODULE_0__angular_core__["Component"])({
            selector: 'app-table',
            template: __webpack_require__("./src/app/pages/reports/balances/component.html")
        }),
...
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_3__component__ = __webpack_require__("./src/app/pages/reports/balances/component.ts");
...
var TABLE_ROUTES = [
    { path: '', component: __WEBPACK_IMPORTED_MODULE_3__component__["a" /* BalancesComponent */] }
];
var BalancesModule = /** @class */ (function () {
    ...
    BalancesModule = __decorate([
        Object(__WEBPACK_IMPORTED_MODULE_1__angular_core__["NgModule"])({
            declarations: [
                __WEBPACK_IMPORTED_MODULE_3__component__["a" /* BalancesComponent */]
            ],
            imports: [
...
//# sourceMappingURL=module.4.chunk.js.map