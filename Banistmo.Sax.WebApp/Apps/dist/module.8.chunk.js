webpackJsonp(["module.8"],{

/***/ "./src/app/pages/params/events/component.html":
...
/***/ "./src/app/pages/params/events/component.ts":
...
var EventsComponent = /** @class */ (function () {
    ...
    EventsComponent.prototype.changePage = function (page, data) {
        if (data === void 0) { data = this.data; }
        var start = (page.page - 1) * page.itemsPerPage;
        var end = page.itemsPerPage > -1 ? (start + page.itemsPerPage) : data.length;
        return data.slice(start, end);
    };
    EventsComponent.prototype.changeSort = function (data, config) {
        if (!config.sorting) {
            return data;
        }
    ...
    EventsComponent.prototype.changeFilter = function (data, config) {
        var _this = this;
    ...
    EventsComponent.prototype.onChangeTable = function (config, page) {
    ...
    EventsComponent = __decorate([
        Object(__WEBPACK_IMPORTED_MODULE_0__angular_core__["Component"])({
            selector: 'app-table',
            template: __webpack_require__("./src/app/pages/params/events/component.html")
        }),
...
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_3__component__ = __webpack_require__("./src/app/pages/params/events/component.ts");
...
var TABLE_ROUTES = [
    { path: '', component: __WEBPACK_IMPORTED_MODULE_3__component__["a" /* EventsComponent */] }
];
var EventsModule = /** @class */ (function () {
    ...
    EventsModule = __decorate([
        Object(__WEBPACK_IMPORTED_MODULE_1__angular_core__["NgModule"])({
            declarations: [
                __WEBPACK_IMPORTED_MODULE_3__component__["a" /* EventsComponent */]
            ],
            imports: [
...
//# sourceMappingURL=module.8.chunk.js.map