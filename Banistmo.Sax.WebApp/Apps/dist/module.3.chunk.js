webpackJsonp(["module.3"],{

/***/ "./src/app/pages/reports/budgets/component.html":
...
/***/ "./src/app/pages/reports/budgets/component.ts":
/***/ (function(module, __webpack_exports__, __webpack_require__) {

"use strict";
/* harmony export (binding) */ __webpack_require__.d(__webpack_exports__, "a", function() { return BudgetsComponent; });
...
var BudgetsComponent = /** @class */ (function () {
    function BudgetsComponent(http) {
        this.http = http;
    ...
    BudgetsComponent.prototype.changePage = function (page, data) {
        if (data === void 0) { data = this.data; }
        var start = (page.page - 1) * page.itemsPerPage;
        var end = page.itemsPerPage > -1 ? (start + page.itemsPerPage) : data.length;
        return data.slice(start, end);
    };
    BudgetsComponent.prototype.changeSort = function (data, config) {
        if (!config.sorting) {
            return data;
        }
    ...
    BudgetsComponent.prototype.changeFilter = function (data, config) {
        var _this = this;
    ...
    BudgetsComponent.prototype.onChangeTable = function (config, page) {
    ...
    BudgetsComponent = __decorate([
        Object(__WEBPACK_IMPORTED_MODULE_0__angular_core__["Component"])({
            selector: 'app-table',
            template: __webpack_require__("./src/app/pages/reports/budgets/component.html")
        }),
...
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_3__component__ = __webpack_require__("./src/app/pages/reports/budgets/component.ts");
...
var TABLE_ROUTES = [
    { path: '', component: __WEBPACK_IMPORTED_MODULE_3__component__["a" /* BudgetsComponent */] }
];
var BudgetsModule = /** @class */ (function () {
    function BudgetsModule() {
    }
    BudgetsModule = __decorate([
        Object(__WEBPACK_IMPORTED_MODULE_1__angular_core__["NgModule"])({
            declarations: [
                __WEBPACK_IMPORTED_MODULE_3__component__["a" /* BudgetsComponent */]
            ],
            imports: [
...
//# sourceMappingURL=module.3.chunk.js.map