webpackJsonp(["module.9"],{

/***/ "./src/app/pages/params/areas/component.html":
...
/***/ "./src/app/pages/params/areas/component.ts":
...
var AreasComponent = /** @class */ (function () {
    ...
    AreasComponent.prototype.changePage = function (page, data) {
        if (data === void 0) { data = this.data; }
        var start = (page.page - 1) * page.itemsPerPage;
        var end = page.itemsPerPage > -1 ? (start + page.itemsPerPage) : data.length;
        return data.slice(start, end);
    };
    AreasComponent.prototype.changeSort = function (data, config) {
        if (!config.sorting) {
            return data;
        }
    ...
    AreasComponent.prototype.changeFilter = function (data, config) {
        var _this = this;
    ...
    AreasComponent.prototype.onChangeTable = function (config, page) {
    ...
    AreasComponent = __decorate([
        Object(__WEBPACK_IMPORTED_MODULE_0__angular_core__["Component"])({
            selector: 'app-table',
            template: __webpack_require__("./src/app/pages/params/areas/component.html")
        }),
...
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_3__component__ = __webpack_require__("./src/app/pages/params/areas/component.ts");
...
var TABLE_ROUTES = [
    { path: '', component: __WEBPACK_IMPORTED_MODULE_3__component__["a" /* AreasComponent */] }
];
var AreasModule = /** @class */ (function () {
    ...
    AreasModule = __decorate([
        Object(__WEBPACK_IMPORTED_MODULE_1__angular_core__["NgModule"])({
            declarations: [
                __WEBPACK_IMPORTED_MODULE_3__component__["a" /* AreasComponent */]
            ],
            imports: [
...
//# sourceMappingURL=module.9.chunk.js.map