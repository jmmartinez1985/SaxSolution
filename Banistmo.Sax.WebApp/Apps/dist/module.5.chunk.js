webpackJsonp(["module.5"],{

/***/ "./src/app/pages/reports/accounts/component.html":
...
/***/ "./src/app/pages/reports/accounts/component.ts":
...
var AccountsComponent = /** @class */ (function () {
    function AccountsComponent(http) {
        this.http = http;
    ...
    AccountsComponent.prototype.changePage = function (page, data) {
        if (data === void 0) { data = this.data; }
        var start = (page.page - 1) * page.itemsPerPage;
        var end = page.itemsPerPage > -1 ? (start + page.itemsPerPage) : data.length;
        return data.slice(start, end);
    };
    AccountsComponent.prototype.changeSort = function (data, config) {
        if (!config.sorting) {
            return data;
        }
    ...
    AccountsComponent.prototype.changeFilter = function (data, config) {
        var _this = this;
    ...
    AccountsComponent.prototype.onChangeTable = function (config, page) {
    ...
    AccountsComponent = __decorate([
        Object(__WEBPACK_IMPORTED_MODULE_0__angular_core__["Component"])({
            selector: 'app-table',
            template: __webpack_require__("./src/app/pages/reports/accounts/component.html")
        }),
...
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_3__component__ = __webpack_require__("./src/app/pages/reports/accounts/component.ts");
...
var TABLE_ROUTES = [
    { path: '', component: __WEBPACK_IMPORTED_MODULE_3__component__["a" /* AccountsComponent */] }
];
var AccountsModule = /** @class */ (function () {
    ...
    AccountsModule = __decorate([
        Object(__WEBPACK_IMPORTED_MODULE_1__angular_core__["NgModule"])({
            declarations: [
                __WEBPACK_IMPORTED_MODULE_3__component__["a" /* AccountsComponent */]
            ],
            imports: [
...
//# sourceMappingURL=module.5.chunk.js.map