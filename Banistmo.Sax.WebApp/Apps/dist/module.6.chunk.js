webpackJsonp(["module.6"],{

/***/ "./src/app/pages/params/system/component.html":
...
/***/ "./src/app/pages/params/system/component.ts":
...
var SystemComponent = /** @class */ (function () {
    ...
    SystemComponent.prototype.changePage = function (page, data) {
        if (data === void 0) { data = this.data; }
        var start = (page.page - 1) * page.itemsPerPage;
        var end = page.itemsPerPage > -1 ? (start + page.itemsPerPage) : data.length;
        return data.slice(start, end);
    };
    SystemComponent.prototype.changeSort = function (data, config) {
        if (!config.sorting) {
            return data;
        }
    ...
    SystemComponent.prototype.changeFilter = function (data, config) {
        var _this = this;
    ...
    SystemComponent.prototype.onChangeTable = function (config, page) {
    ...
    SystemComponent = __decorate([
        Object(__WEBPACK_IMPORTED_MODULE_0__angular_core__["Component"])({
            selector: 'app-table',
            template: __webpack_require__("./src/app/pages/params/system/component.html")
        }),
...
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_3__component__ = __webpack_require__("./src/app/pages/params/system/component.ts");
...
var TABLE_ROUTES = [
    { path: '', component: __WEBPACK_IMPORTED_MODULE_3__component__["a" /* SystemComponent */] }
];
var SystemModule = /** @class */ (function () {
    ...
    SystemModule = __decorate([
        Object(__WEBPACK_IMPORTED_MODULE_1__angular_core__["NgModule"])({
            declarations: [
                __WEBPACK_IMPORTED_MODULE_3__component__["a" /* SystemComponent */]
            ],
            imports: [
...
//# sourceMappingURL=module.6.chunk.js.map