webpackJsonp(["module.7"],{

/***/ "./src/app/pages/params/supervisors/component.html":
...
/***/ "./src/app/pages/params/supervisors/component.ts":
...
var SupervisorsComponent = /** @class */ (function () {
    function SupervisorsComponent(http) {
        this.http = http;
    ...
    SupervisorsComponent.prototype.changePage = function (page, data) {
        if (data === void 0) { data = this.data; }
        var start = (page.page - 1) * page.itemsPerPage;
        var end = page.itemsPerPage > -1 ? (start + page.itemsPerPage) : data.length;
        return data.slice(start, end);
    };
    SupervisorsComponent.prototype.changeSort = function (data, config) {
        if (!config.sorting) {
            return data;
        }
    ...
    SupervisorsComponent.prototype.changeFilter = function (data, config) {
        var _this = this;
    ...
    SupervisorsComponent.prototype.onChangeTable = function (config, page) {
    ...
    SupervisorsComponent = __decorate([
        Object(__WEBPACK_IMPORTED_MODULE_0__angular_core__["Component"])({
            selector: 'app-table',
            template: __webpack_require__("./src/app/pages/params/supervisors/component.html")
        }),
...
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_3__component__ = __webpack_require__("./src/app/pages/params/supervisors/component.ts");
...
var TABLE_ROUTES = [
    { path: '', component: __WEBPACK_IMPORTED_MODULE_3__component__["a" /* SupervisorsComponent */] }
];
var SupervisorsModule = /** @class */ (function () {
    function SupervisorsModule() {
    }
    SupervisorsModule = __decorate([
        Object(__WEBPACK_IMPORTED_MODULE_1__angular_core__["NgModule"])({
            declarations: [
                __WEBPACK_IMPORTED_MODULE_3__component__["a" /* SupervisorsComponent */]
            ],
            imports: [
...
//# sourceMappingURL=module.7.chunk.js.map