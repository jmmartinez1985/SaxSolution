...
/***/ "./src/app/pages/reports/user-logs/component.html":
...
/***/ "./src/app/pages/reports/user-logs/component.ts":
/***/ (function(module, __webpack_exports__, __webpack_require__) {

"use strict";
/* harmony export (binding) */ __webpack_require__.d(__webpack_exports__, "a", function() { return UserLogsComponent; });
...
var UserLogsComponent = /** @class */ (function () {
    function UserLogsComponent(http) {
        this.http = http;
    ...
    UserLogsComponent.prototype.changePage = function (page, data) {
        if (data === void 0) { data = this.data; }
        var start = (page.page - 1) * page.itemsPerPage;
        var end = page.itemsPerPage > -1 ? (start + page.itemsPerPage) : data.length;
        return data.slice(start, end);
    };
    UserLogsComponent.prototype.changeSort = function (data, config) {
        if (!config.sorting) {
            return data;
        }
    ...
    UserLogsComponent.prototype.changeFilter = function (data, config) {
        var _this = this;
    ...
    UserLogsComponent.prototype.onChangeTable = function (config, page) {
    ...
    UserLogsComponent.prototype.ngOnInit = function () {
        this.onChangeTable(this.config);
    };
    UserLogsComponent = __decorate([
        Object(__WEBPACK_IMPORTED_MODULE_0__angular_core__["Component"])({
            selector: 'app-table',
            template: __webpack_require__("./src/app/pages/reports/user-logs/component.html")
        }),
...
/* harmony export (binding) */ __webpack_require__.d(__webpack_exports__, "UserLogsModule", function() { return UserLogsModule; });
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_0__angular_common__ = __webpack_require__("./node_modules/@angular/common/esm5/common.js");
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_1__angular_core__ = __webpack_require__("./node_modules/@angular/core/esm5/core.js");
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_2__angular_router__ = __webpack_require__("./node_modules/@angular/router/esm5/router.js");
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_3__component__ = __webpack_require__("./src/app/pages/reports/user-logs/component.ts");
...
var TABLE_ROUTES = [
    { path: '', component: __WEBPACK_IMPORTED_MODULE_3__component__["a" /* UserLogsComponent */] }
];
var UserLogsModule = /** @class */ (function () {
    function UserLogsModule() {
    }
    UserLogsModule = __decorate([
        Object(__WEBPACK_IMPORTED_MODULE_1__angular_core__["NgModule"])({
            declarations: [
                __WEBPACK_IMPORTED_MODULE_3__component__["a" /* UserLogsComponent */]
            ],
            imports: [
