...
namespace Banistmo.Sax.Services.Implementations.Business
{
    ...
    {
        public List<ExcelDataModel> getDataFrom<T>(T input, string userId)
        {
            int counter = 1;
            ...
            try
            {
                ...
                foreach (var item in ds.Tables[0].AsEnumerable().Skip(1))
                {
                    ...
                    var PA_FECHA_CARGA = (String)item.Field<String>(1) == null ? "" : item.Field<String>(1);
                    var PA_FECHA_TRX = (String)item.Field<String>(2) == null ? "" : item.Field<String>(2);
                    ...
                    var PA_REFERENCIA = (String)item.Field<String>(7) == null ? "" : item.Field<String>(7);
                    ...
                    //    PA_FECHA_CARGA = (String)item.Field<String>(1) == null ? "" : item.Field<String>(1),
                    //    PA_FECHA_TRX = (String)item.Field<String>(2) == null ? "" : item.Field<String>(2),
                    ...
                    //    PA_IMPORTE = (Double)item.Field<Double>(6),
                    //    PA_REFERENCIA = (String)item.Field<String>(7) == null ? "" : item.Field<String>(7),
                    //    PA_EXPLICACION = (String)item.Field<String>(8) == null ? "" : item.Field<String>(8),
                    //    PA_PLAN_ACCION = (String)item.Field<String>(9) == null ? "" : item.Field<String>(9),
