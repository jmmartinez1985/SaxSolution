            ...
            try
            {
                ...
                foreach (var item in ds.Tables[0].AsEnumerable().Skip(1).AsParallel())
                {
                    ...
                    try
                    {
                        ...
                        try { DateTime PA_FECHA_TRX = DateTime.ParseExact(item.Field<String>(2), dateFormat, culture); } catch (Exception e) { listError.Add(new MessageErrorPartida() { Linea = counter++, Mensaje = mensaje, Columna = "PA_FECHA_TRX" }); }
                        try { String PA_CTA_CONTABLE = (String)item.Field<String>(3) == null ? "" : item.Field<String>(3); } catch (Exception e) { listError.Add(new MessageErrorPartida() { Linea = counter++, Mensaje = mensaje, Columna = "PA_CTA_CONTABLE" }); }
                        ...
                        try { String PA_CAMPO_1 = (String)item.Field<String>(11) == null ? "" : item.Field<String>(11); } catch (Exception e) { listError.Add(new MessageErrorPartida() { Linea = counter++, Mensaje = mensaje, Columna = "PA_CAMPO_1" }); }
                        try { String PA_CAMPO_2 = (String)item.Field<String>(12) == null ? "" : item.Field<String>(12); } catch (Exception e) { listError.Add(new MessageErrorPartida() { Linea = counter++, Mensaje = mensaje, Columna = "PA_CAMPO_2" }); }
                        try { String PA_CAMPO_3 = (String)item.Field<String>(13) == null ? "" : item.Field<String>(13); } catch (Exception e) { listError.Add(new MessageErrorPartida() { Linea = counter++, Mensaje = mensaje, Columna = "PA_CAMPO_3" }); }
                        try { String PA_CAMPO_4 = (String)item.Field<String>(14) == null ? "" : item.Field<String>(14); } catch (Exception e) { listError.Add(new MessageErrorPartida() { Linea = counter++, Mensaje = mensaje, Columna = "PA_CAMPO_4" }); }
                        try { String PA_CAMPO_5 = (String)item.Field<String>(15) == null ? "" : item.Field<String>(15); } catch (Exception e) { listError.Add(new MessageErrorPartida() { Linea = counter++, Mensaje = mensaje, Columna = "PA_CAMPO_5" }); }
                        try { String PA_CAMPO_6 = (String)item.Field<String>(16) == null ? "" : item.Field<String>(16); } catch (Exception e) { listError.Add(new MessageErrorPartida() { Linea = counter++, Mensaje = mensaje, Columna = "PA_CAMPO_6" }); }
                        try { String PA_CAMPO_7 = (String)item.Field<String>(17) == null ? "" : item.Field<String>(17); } catch (Exception e) { listError.Add(new MessageErrorPartida() { Linea = counter++, Mensaje = mensaje, Columna = "PA_CAMPO_7" }); }
                        try { String PA_CAMPO_8 = (String)item.Field<String>(18) == null ? "" : item.Field<String>(18); } catch (Exception e) { listError.Add(new MessageErrorPartida() { Linea = counter++, Mensaje = mensaje, Columna = "PA_CAMPO_8" }); }
                        try { String PA_CAMPO_9 = (String)item.Field<String>(19) == null ? "" : item.Field<String>(19); } catch (Exception e) { listError.Add(new MessageErrorPartida() { Linea = counter++, Mensaje = mensaje, Columna = "PA_CAMPO_9" }); }
                        try { String PA_CAMPO_10 = (String)item.Field<String>(20) == null ? "" : item.Field<String>(20); } catch (Exception e) { listError.Add(new MessageErrorPartida() { Linea = counter++, Mensaje = mensaje, Columna = "PA_CAMPO_10" }); }
                        try { String PA_CAMPO_11 = (String)item.Field<String>(21) == null ? "" : item.Field<String>(21); } catch (Exception e) { listError.Add(new MessageErrorPartida() { Linea = counter++, Mensaje = mensaje, Columna = "PA_CAMPO_11" }); }
                        try { String PA_CAMPO_12 = (String)item.Field<String>(22) == null ? "" : item.Field<String>(22); } catch (Exception e) { listError.Add(new MessageErrorPartida() { Linea = counter++, Mensaje = mensaje, Columna = "PA_CAMPO_12" }); }
                        try { String PA_CAMPO_13 = (String)item.Field<String>(23) == null ? "" : item.Field<String>(23); } catch (Exception e) { listError.Add(new MessageErrorPartida() { Linea = counter++, Mensaje = mensaje, Columna = "PA_CAMPO_13" }); }
                        try { String PA_CAMPO_14 = (String)item.Field<String>(24) == null ? "" : item.Field<String>(24); } catch (Exception e) { listError.Add(new MessageErrorPartida() { Linea = counter++, Mensaje = mensaje, Columna = "PA_CAMPO_14" }); }
                        try { String PA_CAMPO_15 = (String)item.Field<String>(25) == null ? "" : item.Field<String>(25); } catch (Exception e) { listError.Add(new MessageErrorPartida() { Linea = counter++, Mensaje = mensaje, Columna = "PA_CAMPO_15" }); }
                        try { String PA_CAMPO_16 = (String)item.Field<String>(26) == null ? "" : item.Field<String>(26); } catch (Exception e) { listError.Add(new MessageErrorPartida() { Linea = counter++, Mensaje = mensaje, Columna = "PA_CAMPO_16" }); }
                        try { String PA_CAMPO_17 = (String)item.Field<String>(27) == null ? "" : item.Field<String>(27); } catch (Exception e) { listError.Add(new MessageErrorPartida() { Linea = counter++, Mensaje = mensaje, Columna = "PA_CAMPO_17" }); }
                        try { String PA_CAMPO_18 = (String)item.Field<String>(28) == null ? "" : item.Field<String>(28); } catch (Exception e) { listError.Add(new MessageErrorPartida() { Linea = counter++, Mensaje = mensaje, Columna = "PA_CAMPO_18" }); }
                        try { String PA_CAMPO_19 = (String)item.Field<String>(29) == null ? "" : item.Field<String>(29); } catch (Exception e) { listError.Add(new MessageErrorPartida() { Linea = counter++, Mensaje = mensaje, Columna = "PA_CAMPO_19" }); }
                        try { String PA_CAMPO_20 = (String)item.Field<String>(30) == null ? "" : item.Field<String>(30); } catch (Exception e) { listError.Add(new MessageErrorPartida() { Linea = counter++, Mensaje = mensaje, Columna = "PA_CAMPO_20" }); }
                        try { String PA_CAMPO_21 = (String)item.Field<String>(31) == null ? "" : item.Field<String>(31); } catch (Exception e) { listError.Add(new MessageErrorPartida() { Linea = counter++, Mensaje = mensaje, Columna = "PA_CAMPO_21" }); }
                        try { String PA_CAMPO_22 = (String)item.Field<String>(32) == null ? "" : item.Field<String>(32); } catch (Exception e) { listError.Add(new MessageErrorPartida() { Linea = counter++, Mensaje = mensaje, Columna = "PA_CAMPO_22" }); }
                        try { String PA_CAMPO_23 = (String)item.Field<String>(33) == null ? "" : item.Field<String>(33); } catch (Exception e) { listError.Add(new MessageErrorPartida() { Linea = counter++, Mensaje = mensaje, Columna = "PA_CAMPO_23" }); }
                        try { String PA_CAMPO_24 = (String)item.Field<String>(34) == null ? "" : item.Field<String>(34); } catch (Exception e) { listError.Add(new MessageErrorPartida() { Linea = counter++, Mensaje = mensaje, Columna = "PA_CAMPO_24" }); }
                        try { String PA_CAMPO_25 = (String)item.Field<String>(35) == null ? "" : item.Field<String>(35); } catch (Exception e) { listError.Add(new MessageErrorPartida() { Linea = counter++, Mensaje = mensaje, Columna = "PA_CAMPO_25" }); }
                        try { String PA_CAMPO_26 = (String)item.Field<String>(35) == null ? "" : item.Field<String>(36); } catch (Exception e) { listError.Add(new MessageErrorPartida() { Linea = counter++, Mensaje = mensaje, Columna = "PA_CAMPO_26" }); }
                        try { String PA_CAMPO_27 = (String)item.Field<String>(37) == null ? "" : item.Field<String>(37); } catch (Exception e) { listError.Add(new MessageErrorPartida() { Linea = counter++, Mensaje = mensaje, Columna = "PA_CAMPO_27" }); }
                        try { String PA_CAMPO_28 = (String)item.Field<String>(38) == null ? "" : item.Field<String>(38); } catch (Exception e) { listError.Add(new MessageErrorPartida() { Linea = counter++, Mensaje = mensaje, Columna = "PA_CAMPO_28" }); }
                        try { String PA_CAMPO_29 = (String)item.Field<String>(39) == null ? "" : item.Field<String>(39); } catch (Exception e) { listError.Add(new MessageErrorPartida() { Linea = counter++, Mensaje = mensaje, Columna = "PA_CAMPO_29" }); }
                        try { String PA_CAMPO_30 = (String)item.Field<String>(40) == null ? "" : item.Field<String>(40); } catch (Exception e) { listError.Add(new MessageErrorPartida() { Linea = counter++, Mensaje = mensaje, Columna = "PA_CAMPO_30" }); }
                        try { String PA_CAMPO_31 = (String)item.Field<String>(41) == null ? "" : item.Field<String>(41); } catch (Exception e) { listError.Add(new MessageErrorPartida() { Linea = counter++, Mensaje = mensaje, Columna = "PA_CAMPO_31" }); }
                        try { String PA_CAMPO_32 = (String)item.Field<String>(42) == null ? "" : item.Field<String>(42); } catch (Exception e) { listError.Add(new MessageErrorPartida() { Linea = counter++, Mensaje = mensaje, Columna = "PA_CAMPO_32" }); }
                        try { String PA_CAMPO_33 = (String)item.Field<String>(43) == null ? "" : item.Field<String>(43); } catch (Exception e) { listError.Add(new MessageErrorPartida() { Linea = counter++, Mensaje = mensaje, Columna = "PA_CAMPO_33" }); }
                        try { String PA_CAMPO_34 = (String)item.Field<String>(44) == null ? "" : item.Field<String>(44); } catch (Exception e) { listError.Add(new MessageErrorPartida() { Linea = counter++, Mensaje = mensaje, Columna = "PA_CAMPO_34" }); }
                        try { String PA_CAMPO_35 = (String)item.Field<String>(45) == null ? "" : item.Field<String>(45); } catch (Exception e) { listError.Add(new MessageErrorPartida() { Linea = counter++, Mensaje = mensaje, Columna = "PA_CAMPO_35" }); }
                        try { String PA_CAMPO_36 = (String)item.Field<String>(46) == null ? "" : item.Field<String>(46); } catch (Exception e) { listError.Add(new MessageErrorPartida() { Linea = counter++, Mensaje = mensaje, Columna = "PA_CAMPO_36" }); }
                        try { String PA_CAMPO_37 = (String)item.Field<String>(47) == null ? "" : item.Field<String>(47); } catch (Exception e) { listError.Add(new MessageErrorPartida() { Linea = counter++, Mensaje = mensaje, Columna = "PA_CAMPO_37" }); }
                        try { String PA_CAMPO_38 = (String)item.Field<String>(48) == null ? "" : item.Field<String>(48); } catch (Exception e) { listError.Add(new MessageErrorPartida() { Linea = counter++, Mensaje = mensaje, Columna = "PA_CAMPO_38" }); }
                        try { String PA_CAMPO_39 = (String)item.Field<String>(49) == null ? "" : item.Field<String>(49); } catch (Exception e) { listError.Add(new MessageErrorPartida() { Linea = counter++, Mensaje = mensaje, Columna = "PA_CAMPO_39" }); }
                        try { String PA_CAMPO_40 = (String)item.Field<String>(50) == null ? "" : item.Field<String>(50); } catch (Exception e) { listError.Add(new MessageErrorPartida() { Linea = counter++, Mensaje = mensaje, Columna = "PA_CAMPO_40" }); }
                        try { String PA_CAMPO_41 = (String)item.Field<String>(51) == null ? "" : item.Field<String>(51); } catch (Exception e) { listError.Add(new MessageErrorPartida() { Linea = counter++, Mensaje = mensaje, Columna = "PA_CAMPO_41" }); }
                        try { String PA_CAMPO_42 = (String)item.Field<String>(52) == null ? "" : item.Field<String>(52); } catch (Exception e) { listError.Add(new MessageErrorPartida() { Linea = counter++, Mensaje = mensaje, Columna = "PA_CAMPO_42" }); }
                        try { String PA_CAMPO_43 = (String)item.Field<String>(53) == null ? "" : item.Field<String>(53); } catch (Exception e) { listError.Add(new MessageErrorPartida() { Linea = counter++, Mensaje = mensaje, Columna = "PA_CAMPO_43" }); }
                        try { String PA_CAMPO_44 = (String)item.Field<String>(54) == null ? "" : item.Field<String>(54); } catch (Exception e) { listError.Add(new MessageErrorPartida() { Linea = counter++, Mensaje = mensaje, Columna = "PA_CAMPO_44" }); }
                        try { String PA_CAMPO_45 = (String)item.Field<String>(55) == null ? "" : item.Field<String>(55); } catch (Exception e) { listError.Add(new MessageErrorPartida() { Linea = counter++, Mensaje = mensaje, Columna = "PA_CAMPO_45" }); }
                        try { String PA_CAMPO_46 = (String)item.Field<String>(56) == null ? "" : item.Field<String>(56); } catch (Exception e) { listError.Add(new MessageErrorPartida() { Linea = counter++, Mensaje = mensaje, Columna = "PA_CAMPO_46" }); }
                        try { String PA_CAMPO_47 = (String)item.Field<String>(57) == null ? "" : item.Field<String>(57); } catch (Exception e) { listError.Add(new MessageErrorPartida() { Linea = counter++, Mensaje = mensaje, Columna = "PA_CAMPO_47" }); }
                        try { String PA_CAMPO_48 = (String)item.Field<String>(58) == null ? "" : item.Field<String>(58); } catch (Exception e) { listError.Add(new MessageErrorPartida() { Linea = counter++, Mensaje = mensaje, Columna = "PA_CAMPO_48" }); }
                    ...
                    catch (Exception e)
                    {
                        ...
                        //listError.Add(new MessageErrorPartida() { Linea = counter++, Mensajes =mensajes});
                    }
